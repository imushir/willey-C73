      ...
      if(studentRef.docs.length == 0){
        ...
        Alert.alert("The student id doesn't exist in the database!")
         ...
         studentRef.docs.map((doc)=>{
            ...
            console.log("Number of booksissued " + student.numberOfBookIssued)
            if(student.numberOfBookIssued < 2){
              console.log("Inside student.numberOfBooksIssued < 2")
    ...
    handleTransaction = async()=>{
     //verify if the student is eligible for book issue or return or none
      ...
      if (!transactionType) {
        ...
        console.log("isStudentEligible for Issue " + isStudentEligible)
